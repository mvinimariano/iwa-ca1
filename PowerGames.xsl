...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Power Games - All Consoles</title>
				...
				<script><![CDATA[
				var gEntreeCount = 0;
				// returns a number that represents the sum of all the selected games
				// item prices.
				...
				// This function either turns on or off the row highlighting for DLC games
